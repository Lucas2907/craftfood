    ...
    return(<section className="populares">
        ...
        <ul className="populares__cards">
            <li className="populares__cards_item">
                <img src="first_populares.png" crossOrigin="anonymous" alt=" imagem ramen de frango" className="populares__cards_title_img"  />
            ...
            <li className="populares__cards_item">
                <img src="second_populares.png" crossOrigin="anonymous" alt="imagem ramen apimentado" className="populares__cards_title_img" />
                <h3 className="populares__cards_item_title">Ramen apimentado</h3>
                <p className="populares__cards_item_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <p className="populares__cards_item_preco">R$ 50</p>
            </li>
            <li className="populares__cards_item">
                <img src="three_populares.png" crossOrigin="anonymous" alt="imagem ramen tradicional" className="populares__cards_title_img" />
